...
namespace eRecruitment.Security
{
    public class ApplicationConfiguration : Westwind.Utilities.Configuration.AppConfiguration
    {
        ...
        private string _ApplicationTitle = "WorkeForce HRMS";
        ...
        private string _DefaultTheme = "SchoolsBee";
    ...
    public class ApplicationSecrets : AppConfiguration
    {
        ...
        protected override IConfigurationProvider OnCreateDefaultProvider(string sectionName, object configData)
        {
            ...
            {
                JsonConfigurationFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "SchoolsBeeKeys.json"),
