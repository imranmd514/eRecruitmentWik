...
namespace Models
{
    public class ApprovedJobsBO
    {
        ...
        public string HROfficeBy { get; set; }
        public string HROffice_Date { get; set; }
        public string HROffice_Comments { get; set; }
        public string HOPBy { get; set; }
        public string HOP_Comments { get; set; }
        ...
        public string HAFBy { get; set; }
        public string HAF_Date { get; set; }
        public string HAF_Comments { get; set; }
